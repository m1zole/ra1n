...
//  ra1n
//
//  Created by mizole on 2023/11/29.
//

#import <Foundation/Foundation.h>

#import "ra1n-Bridging-Header.h"
...
int spawnRoot(NSString* binary, NSArray* args)
{
    NSString* path = [NSString stringWithFormat:@"%@%@%@", NSBundle.mainBundle.bundlePath, @"/", binary];
